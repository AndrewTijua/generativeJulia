...
function init_edge_tables(x0::Int64, y0::Int64, n::Int64, omega::Float64, seed1, seed2, igt)
...
function Amortised_Noise_2D_cell(x::Int64, y::Int64, n::Int64, seed_1::Int64, seed_2::Int64, omega::Float64, cell, scale::Float64, m0::Int64, m1::Int64)
    ...
    for i0 = 0:(r-1)
        for j0 = 0:(r-1)
            igt = init_edge_tables(x + i0, y + j0, n, omega, seed_1, seed_2, igt)
...
# grd = AMN_2D_grid((12, 11), 12, 456768, 0.1, 0.65, 1, 5, 1024)
# # grd = grd[1:1023, 1:1023]
# plot(1:1024, 1:1024, grd, st = :heatmap, c = :grays)
